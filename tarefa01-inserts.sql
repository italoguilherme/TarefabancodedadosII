...
insert into funcionario
(nome, sexo, dtNasc, salario, codDepto)
values ('Xuxa', 'F', '1970-03-28', 13500.00, null);

insert into funcionario
(nome, sexo, dtNasc, salario, codDepto)
values ('Sasha', 'F', '1970-03-28', 1500.00, 1);

insert into funcionario
(nome, sexo, dtNasc, salario, codDepto)
values ('Victor', 'M', '1970-03-28', 500.00, 1);

insert into funcionario
(nome, sexo, dtNasc, salario, codDepto)
values ('Doisberto', 'M', '1980-07-14', 2500.00, 3);

insert into funcionario
(nome, sexo, dtNasc, salario, codDepto)
values ('Tresberta', 'F', '1992-09-01', 3000.00, 3);
